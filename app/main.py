...
from .config import API_TITLE, API_VERSION, API_PATH
from .model import HGBCModel
from .schemas import SepsisBatchRequest, SepsisScore

FEATURES = ['ICULOS','Temp','BaseExcess','DBP','FiO2','Gender','Age','HCO3','HR','HospAdmTime','Magnesium','O2Sat','Resp']
...
@api.get("/health")
def health():
    return {"status": "ok", "model": "HGB", "version": API_VERSION, "threshold": model.threshold}
